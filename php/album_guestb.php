...
//**************** GB DATA  ***********************************
  ...
  // eval data (non dynamic)
   for($i = 0; $i<$data->rowanz; $i++){
    ...
    if (str_replace("www.","",$data->rowcontent[$i][3])!="") $info.="&nbsp;URL:&nbsp;<a href=http://".$data->rowcontent[$i][3]." target=_blank class=linksmall>".$data->rowcontent[$i][3]."</a>&nbsp;|&nbsp;";
 ...
 statistic($cfg_sitename, "Guestbook", $cook_id, "visit", $connr);
