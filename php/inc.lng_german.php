<?php
 ...
 //album_headln.php
  $lng_headlnmenu[]="TobiCam";          $lng_headlnlink[]="album_cam.php?PHPSESSID=$PHPSESSID";
 ...
 //album_confirm.php
  ...
  $lng_confmsg="Die Nachricht wurde erfolgreich gesendet. <br>Vielleicht werde ich nun die TobiCam aktivieren, besuche die Seite in 3min nochmal.";
