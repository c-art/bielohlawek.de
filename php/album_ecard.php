...
<html>
 ...
 <script language="JavaScript" src="norclick2.js"></script>
<!-- <link rel=stylesheet type="text/css" href="style.css"> -->
 <!-- init Script for cheking Formularinput -->
 <?php echo $entry->init_checkinput().$entry->init_openwindow(); ?>
 ...
 <script language='Javascript'>
     function checkLocal(form) {
      for (k=0; k<document.forms[form].length; k++) {
       ...
       alert('hi');
       if ((fieldname.indexOf('email')>0) && (document.forms[form].elements[k].value.indexOf('sagmal') && (document.forms[form].elements[k].type != 'hidden'))) {
 ...
 <?php
      //Output Variables
       echo"<form action=$togo onsubmit=\"return (checkLocal(0))\">
